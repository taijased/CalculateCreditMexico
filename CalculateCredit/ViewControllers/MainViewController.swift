...
class MainViewController: UIViewController {
    ...
    var differViewPopup: ResultDifferPopupView!
    var annuitViewPopup: ResultAnnuitPopupView!
    ...
    func showDifferPopup() {
        ...
        DispatchQueue.main.async {
            self.differViewPopup = ResultDifferPopupView.createPopup(months: months, percent: CGFloat(truncating: percent), sum: sum, rootVC: self)
    ...
    func showAnnuitPopup() {
        ...
        DispatchQueue.main.async {
            self.annuitViewPopup = ResultAnnuitPopupView.createPopup(months: months, percent: CGFloat(truncating: percent), sum: sum, rootVC: self)
    ...
    @IBAction func completeAction(_ sender: Any) {
        ...
        if checkFields() {
            ...
            let alert = UIAlertController(title: "Error de datos", message: "Introduzca los datos correctos para que el resultado sea correcto", preferredStyle: .actionSheet)
            alert.addAction(UIAlertAction(title: "Más información", style: .default, handler: { _ in
